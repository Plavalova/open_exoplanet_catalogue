...
for row in csvfile:
    ...
    rastring = "%02d %02d %02d" % (math.floor(ra), math.floor((ra - math.floor(ra)) * 60.),
                                   (ra - math.floor(ra) - math.floor((ra - math.floor(ra)) * 60.) / 60.) * 60. * 60.)
    decstring = "+%02d %02d %02d" % (math.floor(dec), math.floor((dec - math.floor(dec)) * 60.), (
    dec - math.floor(dec) - math.floor((dec - math.floor(dec)) * 60.) / 60.) * 60. * 60.)
